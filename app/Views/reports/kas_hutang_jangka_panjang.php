...
<div class="card">
   <div class="card-header">
      <h3 class="card-title">Kas Hutang Jangka Panjang</h3>
   </div>
...
<div class="row px-2">
        ...
        <div class="card bg-primary">
            <div class="d-flex justify-content-between align-items-center p-3">
                <div>
                    ...
                    <h3 class="font-weight-bold">Rp1,481,151,001</h3>
                </div>
                <div>
   ...
   <div class="card">
            <div class="d-flex justify-content-between align-items-center p-3">
                <div>
                    <h6 class="text-black-50 font-weight-light">KAS YANG DITERIMA DARI HUTANG JANGKA PANJANG</h6>
                    <h3 class="font-weight-bold">Rp. 1,481,151,001</h3>
                </div>
                <div>
      ...
      <table class="table table-bordered" id="dataGridAktivaPembangunan">
         ...
         <tfoot>
            <tr>
               ...
               <th id="totalMonthly">Rp. 1,481,151,001</th>
            </tr>
         </tfoot>
      </table>
   </div>
